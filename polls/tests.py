...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_no_questions(self):
        """
        if no questions exist, an appropriate message would be displayed
        """
    ...
    def test_index_view_with_future_and_past_question(self):
        """
        question with pub_date in past would be displayed but question with pub_date in the future would not
        """
        create_question(question_text="Past question.", days=-30)
        create_question(question_text="Future question.", days=30)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_index_view_with_two_past_questions(self):
        """
        question with pub_date in the past would be displayed on the index page
        """
        create_question(question_text="Past question 1", days=-30)
        create_question(question_text="Past question 2", days=-45)
        response = self.client.get(reverse('polls:index'))
...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detail_view_with_past_questions(self):
        """
        the detail view of a question with pub_date in the past should display the question
        """
